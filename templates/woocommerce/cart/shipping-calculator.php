...
<form class="woocommerce-shipping-calculator  sv_d-none sv_toggle_cart_shipping" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-form">
		...
		<?php endif; ?>
		<p><button type="submit" name="calc_shipping" value="1" class="button wc-action-btn mb-3"><?php esc_html_e( 'Update totals', 'shipvista' ); ?></button></p>
